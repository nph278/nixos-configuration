...
vim.cmd("highlight NvimLspDiagnosticsDefaultError ctermfg=1")
vim.cmd("highlight NvimLspDiagnosticsDefaultWarning ctermfg=3")
vim.cmd("highlight NvimLspDiagnosticsDefaultHint ctermfg=4")
vim.cmd("highlight NvimLspDiagnosticsDefaultInformation ctermfg=4")
